        ...
        <header className='bg-orange-200'>
            <div className='container m-auto py-2 flex justify-between items-center'>
                ...
                <nav className='flex gap-20'>
                    ...
                    <a className='className="text-white hover:bg-orange-700 hover:text-white text-lg hover:rounded uppercase font-semibold"' href="">Ofertas</a>
                    <a className='className="text-white hover:bg-orange-700 hover:text-white hover:rounded text-lg uppercase font-semibold"' href="">Contacto</a>
                </nav>
                { <CartWidget /> }
            </div>
        </header>
